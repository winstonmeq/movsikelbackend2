...
"[project]/app/api/driver/requests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (auth.role !== 'driver') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Only drivers can load ride requests', 403);
        ...
        const driver = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findById(auth.sub).select('online currentLocation');
        ...
        if (!driver.online) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])({
            rides: [],
            online: false
        });
        let rides = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Ride$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Ride"].find({
            status: 'requested',
            candidateDriverIds: driverObjectId
        }).sort({
            createdAt: -1
        }).limit(20).populate('passengerId', 'name phone').lean();
        ...
        if (rides.length === 0 && showOpenRidesFallback()) {
            rides = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Ride$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Ride"].find({
                status: 'requested'
            }).sort({
                createdAt: -1
            }).limit(20).populate('passengerId', 'name phone').lean();
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])(err instanceof Error ? err.message : 'Could not load ride requests');
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1_y29ww._.js.map