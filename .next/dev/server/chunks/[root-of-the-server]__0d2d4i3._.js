...
"[project]/app/api/rides/[rideId]/cancel/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, context) {
    try {
        ...
        if (auth.role !== 'passenger') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Only passengers can cancel passenger rides', 403);
        ...
        if (ride.status === 'cancelled') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])({
            ride,
            message: 'Ride already cancelled'
        });
        if (ride.status === 'completed') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Completed rides cannot be cancelled', 409);
        if (ride.status === 'in_progress') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Ride already in progress and cannot be cancelled from the passenger app', 409);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$realtime$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emitToUsers"])([
            ...notifyUserIds
        ], 'ride:update', {
            ride,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])(err instanceof Error ? err.message : 'Could not cancel ride');
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0d2d4i3._.js.map