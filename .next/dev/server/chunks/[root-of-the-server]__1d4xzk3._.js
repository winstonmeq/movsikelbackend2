...
"[project]/app/api/rides/history/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (auth.role !== 'passenger') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Only passengers can view passenger trip history', 403);
        const rides = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Ride$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Ride"].find({
            ...
            createdAt: -1
        }).limit(50).populate('driverId', 'name phone vehicleType plateNumber tricycleNumber');
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])(err instanceof Error ? err.message : 'Could not load trip history');
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1d4xzk3._.js.map