...
"[project]/app/api/rides/[rideId]/simulate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, context) {
    try {
        ...
        if (auth.role !== 'passenger') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Only passengers can start a dummy ride simulation', 403);
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDriver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dummyDriverEnabled"])()) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Dummy driver simulation is disabled. Set DUMMY_DRIVER_ENABLED=true only when you want demo mode.', 409);
        }
        ...
        const ride = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Ride$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Ride"].findById(rideId);
        if (!ride) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Ride not found', 404);
        if (String(ride.passengerId) !== auth.sub) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Forbidden', 403);
        if (ride.status === 'completed' || ride.status === 'cancelled') {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])({
                ...
                simulator: {
                    started: false,
                    message: 'Ride is already finished.'
                }
            });
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDriver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prepareDummyDriverCandidate"])(rideId);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDriver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["scheduleDummyRideSimulation"])(rideId, {
            force: true
        });
        const updatedRide = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Ride$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Ride"].findById(rideId).populate('driverId', 'name phone vehicleType plateNumber tricycleNumber currentLocation heading');
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])({
            ride: updatedRide,
            simulator: {
                started: true,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])(err instanceof Error ? err.message : 'Could not start dummy driver simulation');
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__05h6tva._.js.map