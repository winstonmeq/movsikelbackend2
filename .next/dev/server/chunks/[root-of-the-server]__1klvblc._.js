...
"[project]/app/api/driver/rides/[rideId]/accept/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, context) {
    try {
        ...
        if (auth.role !== 'driver') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Only drivers can accept rides', 403);
        ...
        const driverObjectId = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].Types.ObjectId(auth.sub);
        const driver = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findById(auth.sub).select('name phone vehicleType plateNumber tricycleNumber currentLocation heading online').lean();
        ...
        if (driver.online !== true) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Go online before accepting a ride', 409);
        const existingRide = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Ride$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Ride"].findOne({
            ...
            status: 'requested'
        }).select('candidateDriverIds passengerId').lean();
        if (!existingRide) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Ride is no longer available', 409);
        const candidateIds = (existingRide.candidateDriverIds || []).map(String);
        const isCandidate = candidateIds.includes(String(driverObjectId));
        if (candidateIds.length > 0 && !isCandidate && !allowOpenRideAccept()) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('This ride was not assigned to your driver app', 403);
        }
        ...
        if (!ride) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('Ride is no longer available', 409);
        const update = {
            ride,
            driver
        };
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])(err instanceof Error ? err.message : 'Could not accept ride');
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1klvblc._.js.map